...
/*    String imgA = "imgA.jpg";
    String imgB = "imgB.jpg";
    String imgC = "imgC.jpg";*/
   ...
   AmazonRekognition rekognitionClient = AmazonRekognitionClientBuilder.defaultClient();
    ...
    public String compareDifferentFaces(String imgA, String imgC) {
        if(imgA.isEmpty() || imgC.isEmpty()){
            throw new ResourceNotFoundException();
        }
        String result = "";
        ...
        CompareFacesRequest request = new CompareFacesRequest()
                .withSourceImage(new Image().withS3Object(new S3Object()
                        .withName(imgA).withBucket(bucket))).withTargetImage(new Image()
                        .withS3Object(new S3Object().withName(imgC).withBucket(bucket)))
                .withSimilarityThreshold(70F);
